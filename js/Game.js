class Game {
        ...
        displayRanks(){
          ...
          image(bronze_img,displayWidth/-4,-100+displayHeight/10,200,250);
          textSize(50);
          textAlign(CENTER);
          Player.getPlayerInfo();
          ...
          if (allPlayers[plr].place === 1){
            text(allPlayers [plr].name,0,85)
          }  
          else if(allPlayers[plr].place === 2){
            text(allPlayers [plr].name,displayWidth/4,displayHeight/10+75);
          }  
          else if(allPlayers[plr].place === 3){
            text(allPlayers [plr].name,displayWidth/-4,displayHeight/10+75);
          } 
          else{
            text(allPlayers[plr].name,0,250);
          } 
          }
        }
      }
